...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //输出加密内容
        DDLoggerSwift.privacyLogPassword = "12345678901234561234567890123456" //设置加密内容密码
        DDLoggerSwift.uploadComplete = { filePath in
            print(filePath)
        }
    }
...
//        ZXKit.show()
        ...
        printInfo("点击了按钮111")
        printError("错误出现")
        printInfo("调试数据文件地址", DDLoggerSwift.getDBFolder().path)
        printWarn("警告提示")
