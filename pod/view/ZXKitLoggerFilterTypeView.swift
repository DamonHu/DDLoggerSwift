...
protocol ZXKitLoggerFilterTypeViewDelegate: AnyObject {
...
class ZXKitLoggerFilterTypeView: UIView {
    ...
    private lazy var mTableView: UITableView = {
        ...
        tableView.backgroundColor = UIColor.zx.color(hexValue: 0xfcfcfc)
        tableView.separatorColor = UIColor.zx.color(hexValue: 0xcccccc)
...
extension ZXKitLoggerFilterTypeView: UITableViewDelegate, UITableViewDataSource {
